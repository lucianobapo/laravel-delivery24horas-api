 ...
 */
class PartnerSharedStat extends \App\Models\Doctrine\Entities\PartnerSharedStat implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PartnerSharedStat $proxy) {
