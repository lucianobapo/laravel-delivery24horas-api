 ...
 */
class SharedUnitOfMeasure extends \App\Models\Doctrine\Entities\SharedUnitOfMeasure implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SharedUnitOfMeasure $proxy) {
