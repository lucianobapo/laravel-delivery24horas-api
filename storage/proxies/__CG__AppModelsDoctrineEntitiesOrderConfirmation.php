 ...
 */
class OrderConfirmation extends \App\Models\Doctrine\Entities\OrderConfirmation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OrderConfirmation $proxy) {
