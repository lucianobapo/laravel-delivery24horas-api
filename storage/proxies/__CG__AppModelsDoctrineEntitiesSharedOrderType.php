 ...
 */
class SharedOrderType extends \App\Models\Doctrine\Entities\SharedOrderType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SharedOrderType $proxy) {
