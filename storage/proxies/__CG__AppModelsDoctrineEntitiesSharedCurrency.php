 ...
 */
class SharedCurrency extends \App\Models\Doctrine\Entities\SharedCurrency implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SharedCurrency $proxy) {
    ...
    public function setNomeUniversal($nome_universal)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNomeUniversal', [$nome_universal]);

        return parent::setNomeUniversal($nome_universal);
    }
    ...
    public function getNomeUniversal()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNomeUniversal', []);

        return parent::getNomeUniversal();
    }
